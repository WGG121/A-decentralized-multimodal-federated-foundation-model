...
class CXR_module(nn.Module):
    def __init__(self, backbone='resnet18', embed_size=512, device='cpu'):
        ...
        if backbone == 'resnet18':
            ...
            self.res_antero_posterior = resnet18(pretrained=False)
            self.res_left_lateral = resnet18(pretrained=False)
            self.res_postero_anterior = resnet18(pretrained=False)
            self.res_lateral = resnet18(pretrained=False)
